...
comes,& says you are not allowed to eat your own {Food}.The smart friends look at eachother & laugh & exchanged their {Food}.'''
  ...
  Label(ml2_wn, text='Drink:', font=("Times", 15), bg='RoyalBlue2').place(x=0, y=110)
  Label(ml2_wn, text='Food:', font=("Times", 15), bg='RoyalBlue2').place(x=0, y=150)
  Label(ml2_wn, text='Festaurant:', font=("Times", 15), bg='RoyalBlue2').place(x=0, y=190)
  Label(ml2_wn, text='Passion:', font=("Times", 15), bg='RoyalBlue2').place(x=0, y=230)
  ...
  Drink_entry = Entry(ml2_wn, width=19)
  Drink_entry.place(x=255, y=110)
  Food_entry = Entry(ml2_wn, width=19)
  Food_entry.place(x=255, y=150)
  Restaurant_entry = Entry(ml2_wn, width=19)
  Restaurant_entry.place(x=255, y=190)
  Passion_entry = Entry(ml2_wn, width=19)
  Passion_entry.place(x=255, y=230)
  submit_btn = Button(ml2_wn, text="Submit", background="SteelBlue", font=('Times', 12), command=lambda: finish_madlib(ml2_wn, Yourname_entry.get(), Friendname_entry.get(), Drink_entry.get(), Food_entry.get(), Restaurant_entry.get(), Passion_entry.get())
  submit_btn.place(x=150, y=270)
  ml2_wn.mainloop()
def third_madlib(win):
